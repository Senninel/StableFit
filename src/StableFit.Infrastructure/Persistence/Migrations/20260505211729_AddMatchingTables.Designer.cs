...
namespace StableFit.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260505211729_AddMatchingTables")]
    partial class AddMatchingTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StableFit.Infrastructure.Persistence.Entities.Match", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("StableFit.Infrastructure.Persistence.Entities.MatchDecision", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RunId", "ToUserId")
                        .HasDatabaseName("ix_match_decisions_run_to");

                    b.HasIndex("RunId", "FromUserId", "ToUserId")
                        .IsUnique()
                        .HasDatabaseName("ux_match_decisions_run_from_to");

                    b.ToTable("match_decisions", (string)null);
                });

            modelBuilder.Entity("StableFit.Infrastructure.Persistence.Entities.MatchRecommendation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RunId", "UserId", "Rank")
                        .IsUnique()
                        .HasDatabaseName("ix_match_recommendations_run_user_rank");

                    b.HasIndex("RunId", "UserId", "RecommendedUserId")
                        .IsUnique()
                        .HasDatabaseName("ux_match_recommendations_run_user_recommended");

                    b.ToTable("match_recommendations", (string)null);
                });
